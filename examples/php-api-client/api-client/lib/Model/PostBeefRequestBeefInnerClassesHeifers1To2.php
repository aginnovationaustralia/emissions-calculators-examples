...
/**
 * PostBeefRequestBeefInnerClassesHeifers1To2 Class Doc Comment
 *
 * @category Class
 ...
 */
class PostBeefRequestBeefInnerClassesHeifers1To2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_beef_request_beef_inner_classes_heifers1To2';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostBeefRequestBeefInnerClassesHeifers1To2., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostBeefRequestBeefInnerClassesHeifers1To2., must be bigger than or equal to 0.');
        }
