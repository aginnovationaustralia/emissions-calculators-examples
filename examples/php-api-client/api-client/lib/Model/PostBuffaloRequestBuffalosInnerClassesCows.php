...
/**
 * PostBuffaloRequestBuffalosInnerClassesCows Class Doc Comment
 *
 * @category Class
 * @description Cows
 * @package  OpenAPI\Client
 ...
 */
class PostBuffaloRequestBuffalosInnerClassesCows implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_buffalo_request_buffalos_inner_classes_cows';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostBuffaloRequestBuffalosInnerClassesCows., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostBuffaloRequestBuffalosInnerClassesCows., must be bigger than or equal to 0.');
        }
