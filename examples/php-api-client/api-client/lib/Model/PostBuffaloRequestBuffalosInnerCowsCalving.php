...
/**
 * PostBuffaloRequestBuffalosInnerCowsCalving Class Doc Comment
 *
 * @category Class
 ...
 */
class PostBuffaloRequestBuffalosInnerCowsCalving implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_buffalo_request_buffalos_inner_cowsCalving';
    ...
    */
    ...
    public function setSpring($spring)
    {
        ...
        if (($spring > 1)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be smaller than or equal to 1.');
        }
        if (($spring < 0)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be bigger than or equal to 0.');
        }
    ...
    public function setSummer($summer)
    {
        ...
        if (($summer > 1)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be smaller than or equal to 1.');
        }
        if (($summer < 0)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be bigger than or equal to 0.');
        }
    ...
    public function setAutumn($autumn)
    {
        ...
        if (($autumn > 1)) {
            throw new \InvalidArgumentException('invalid value for $autumn when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be smaller than or equal to 1.');
        }
        if (($autumn < 0)) {
            throw new \InvalidArgumentException('invalid value for $autumn when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be bigger than or equal to 0.');
        }
    ...
    public function setWinter($winter)
    {
        ...
        if (($winter > 1)) {
            throw new \InvalidArgumentException('invalid value for $winter when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be smaller than or equal to 1.');
        }
        if (($winter < 0)) {
            throw new \InvalidArgumentException('invalid value for $winter when calling PostBuffaloRequestBuffalosInnerCowsCalving., must be bigger than or equal to 0.');
        }
