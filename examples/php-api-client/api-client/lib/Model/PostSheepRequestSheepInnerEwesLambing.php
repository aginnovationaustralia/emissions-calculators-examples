...
/**
 * PostSheepRequestSheepInnerEwesLambing Class Doc Comment
 *
 * @category Class
 ...
 */
class PostSheepRequestSheepInnerEwesLambing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_sheep_request_sheep_inner_ewesLambing';
    ...
    */
    ...
    public function setSpring($spring)
    {
        ...
        if (($spring > 1)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostSheepRequestSheepInnerEwesLambing., must be smaller than or equal to 1.');
        }
        if (($spring < 0)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostSheepRequestSheepInnerEwesLambing., must be bigger than or equal to 0.');
        }
    ...
    public function setSummer($summer)
    {
        ...
        if (($summer > 1)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostSheepRequestSheepInnerEwesLambing., must be smaller than or equal to 1.');
        }
        if (($summer < 0)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostSheepRequestSheepInnerEwesLambing., must be bigger than or equal to 0.');
        }
