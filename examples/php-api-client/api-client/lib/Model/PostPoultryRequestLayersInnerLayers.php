...
class PostPoultryRequestLayersInnerLayers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAutumn($autumn)
    {
        ...
        if (($autumn < 0)) {
            throw new \InvalidArgumentException('invalid value for $autumn when calling PostPoultryRequestLayersInnerLayers., must be bigger than or equal to 0.');
        }
    ...
    public function setWinter($winter)
    {
        ...
        if (($winter < 0)) {
            throw new \InvalidArgumentException('invalid value for $winter when calling PostPoultryRequestLayersInnerLayers., must be bigger than or equal to 0.');
        }
    ...
    public function setSpring($spring)
    {
        ...
        if (($spring < 0)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostPoultryRequestLayersInnerLayers., must be bigger than or equal to 0.');
        }
    ...
    public function setSummer($summer)
    {
        ...
        if (($summer < 0)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostPoultryRequestLayersInnerLayers., must be bigger than or equal to 0.');
        }
