...
/**
 * PostProcessing200ResponseIntermediateInner Class Doc Comment
 *
 * @category Class
 * @description Intermediate emissions calculation output for the Processing calculator
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostProcessing200ResponseIntermediateInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_processing_200_response_intermediate_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier for this Processing activity
     *
     * @return self
     */
