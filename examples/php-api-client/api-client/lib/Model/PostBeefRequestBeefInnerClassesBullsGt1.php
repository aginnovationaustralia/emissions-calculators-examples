...
/**
 * PostBeefRequestBeefInnerClassesBullsGt1 Class Doc Comment
 *
 * @category Class
 ...
 */
class PostBeefRequestBeefInnerClassesBullsGt1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_beef_request_beef_inner_classes_bullsGt1';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostBeefRequestBeefInnerClassesBullsGt1., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostBeefRequestBeefInnerClassesBullsGt1., must be bigger than or equal to 0.');
        }
