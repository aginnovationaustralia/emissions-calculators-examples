...
/**
 * PostBuffaloRequestBuffalosInnerClassesBullsPurchasesInner Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PostBuffaloRequestBuffalosInnerClassesBullsPurchasesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_buffalo_request_buffalos_inner_classes_bulls_purchases_inner';
    ...
    */
    ...
    public function setHead($head)
    {
        ...
        if (($head < 0)) {
            throw new \InvalidArgumentException('invalid value for $head when calling PostBuffaloRequestBuffalosInnerClassesBullsPurchasesInner., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchaseWeight($purchase_weight)
    {
        ...
        if (($purchase_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $purchase_weight when calling PostBuffaloRequestBuffalosInnerClassesBullsPurchasesInner., must be bigger than or equal to 0.');
        }
