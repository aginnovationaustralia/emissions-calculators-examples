...
/**
 * PostBuffaloRequestBuffalosInnerClassesTradeCows Class Doc Comment
 *
 * @category Class
 ...
 */
class PostBuffaloRequestBuffalosInnerClassesTradeCows implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_buffalo_request_buffalos_inner_classes_tradeCows';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostBuffaloRequestBuffalosInnerClassesTradeCows., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostBuffaloRequestBuffalosInnerClassesTradeCows., must be bigger than or equal to 0.');
        }
