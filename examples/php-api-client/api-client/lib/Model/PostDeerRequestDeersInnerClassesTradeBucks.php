...
/**
 * PostDeerRequestDeersInnerClassesTradeBucks Class Doc Comment
 *
 * @category Class
 ...
 */
class PostDeerRequestDeersInnerClassesTradeBucks implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_deer_request_deers_inner_classes_tradeBucks';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostDeerRequestDeersInnerClassesTradeBucks., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostDeerRequestDeersInnerClassesTradeBucks., must be bigger than or equal to 0.');
        }
