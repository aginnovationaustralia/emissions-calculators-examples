...
/**
 * PostSheepRequestSheepInnerSeasonalLambing Class Doc Comment
 *
 * @category Class
 ...
 */
class PostSheepRequestSheepInnerSeasonalLambing implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_sheep_request_sheep_inner_seasonalLambing';
    ...
    */
    ...
    public function setAutumn($autumn)
    {
        ...
        if (($autumn < 0)) {
            throw new \InvalidArgumentException('invalid value for $autumn when calling PostSheepRequestSheepInnerSeasonalLambing., must be bigger than or equal to 0.');
        }
    ...
    public function setWinter($winter)
    {
        ...
        if (($winter < 0)) {
            throw new \InvalidArgumentException('invalid value for $winter when calling PostSheepRequestSheepInnerSeasonalLambing., must be bigger than or equal to 0.');
        }
    ...
    public function setSpring($spring)
    {
        ...
        if (($spring < 0)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostSheepRequestSheepInnerSeasonalLambing., must be bigger than or equal to 0.');
        }
    ...
    public function setSummer($summer)
    {
        ...
        if (($summer < 0)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostSheepRequestSheepInnerSeasonalLambing., must be bigger than or equal to 0.');
        }
