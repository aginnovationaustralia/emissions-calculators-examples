...
/**
 * PostPorkRequestPorkInnerClassesGilts Class Doc Comment
 *
 * @category Class
 * @description Gilts
 * @package  OpenAPI\Client
 ...
 */
class PostPorkRequestPorkInnerClassesGilts implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_pork_request_pork_inner_classes_gilts';
    ...
    */
    ...
    public function setAutumn($autumn)
    {
        ...
        if (($autumn < 0)) {
            throw new \InvalidArgumentException('invalid value for $autumn when calling PostPorkRequestPorkInnerClassesGilts., must be bigger than or equal to 0.');
        }
    ...
    public function setWinter($winter)
    {
        ...
        if (($winter < 0)) {
            throw new \InvalidArgumentException('invalid value for $winter when calling PostPorkRequestPorkInnerClassesGilts., must be bigger than or equal to 0.');
        }
    ...
    public function setSpring($spring)
    {
        ...
        if (($spring < 0)) {
            throw new \InvalidArgumentException('invalid value for $spring when calling PostPorkRequestPorkInnerClassesGilts., must be bigger than or equal to 0.');
        }
    ...
    public function setSummer($summer)
    {
        ...
        if (($summer < 0)) {
            throw new \InvalidArgumentException('invalid value for $summer when calling PostPorkRequestPorkInnerClassesGilts., must be bigger than or equal to 0.');
        }
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostPorkRequestPorkInnerClassesGilts., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostPorkRequestPorkInnerClassesGilts., must be bigger than or equal to 0.');
        }
