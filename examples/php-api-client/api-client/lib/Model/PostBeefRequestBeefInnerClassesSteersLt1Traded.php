...
class PostBeefRequestBeefInnerClassesSteersLt1Traded implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostBeefRequestBeefInnerClassesSteersLt1Traded., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostBeefRequestBeefInnerClassesSteersLt1Traded., must be bigger than or equal to 0.');
        }
