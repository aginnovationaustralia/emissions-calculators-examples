...
/**
 * PostBuffaloRequestBuffalosInnerClassesTradeCalfs Class Doc Comment
 *
 * @category Class
 ...
 */
class PostBuffaloRequestBuffalosInnerClassesTradeCalfs implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_buffalo_request_buffalos_inner_classes_tradeCalfs';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostBuffaloRequestBuffalosInnerClassesTradeCalfs., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostBuffaloRequestBuffalosInnerClassesTradeCalfs., must be bigger than or equal to 0.');
        }
