...
/**
 * PostSugarRequestVegetationInner Class Doc Comment
 *
 * @category Class
 * @description Non-productive vegetation inputs along with allocations to each Sugar activity
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostSugarRequestVegetationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_sugar_request_vegetation_inner';
    ...
    */
     ...
     *
     * @param float[] $allocation_to_crops The proportion of the sequestration that is allocated to each sugar activity
     *
     * @return self
     */
