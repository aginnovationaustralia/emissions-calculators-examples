...
/**
 * PostRiceRequestVegetationInner Class Doc Comment
 *
 * @category Class
 * @description Non-productive vegetation inputs along with allocations to each Rice activity
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostRiceRequestVegetationInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_rice_request_vegetation_inner';
