...
/**
 * PostPork200ResponseIntermediateInner Class Doc Comment
 *
 * @category Class
 * @description Intermediate emissions calculation output for the Pork calculator
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PostPork200ResponseIntermediateInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_pork_200_response_intermediate_inner';
    ...
    */
     ...
     * Sets id
     *
     * @param string $id Unique identifier for this Pork activity
     *
     * @return self
     */
