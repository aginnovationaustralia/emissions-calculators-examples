...
/**
 * PostPoultryRequestBroilersInnerMeatOtherPurchases Class Doc Comment
 *
 * @category Class
 ...
 */
class PostPoultryRequestBroilersInnerMeatOtherPurchases implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_poultry_request_broilers_inner_meatOtherPurchases';
    ...
    */
    ...
    public function setHead($head)
    {
        ...
        if (($head < 0)) {
            throw new \InvalidArgumentException('invalid value for $head when calling PostPoultryRequestBroilersInnerMeatOtherPurchases., must be bigger than or equal to 0.');
        }
    ...
    public function setPurchaseWeight($purchase_weight)
    {
        ...
        if (($purchase_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $purchase_weight when calling PostPoultryRequestBroilersInnerMeatOtherPurchases., must be bigger than or equal to 0.');
        }
