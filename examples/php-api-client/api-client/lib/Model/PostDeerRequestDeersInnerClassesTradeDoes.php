...
/**
 * PostDeerRequestDeersInnerClassesTradeDoes Class Doc Comment
 *
 * @category Class
 ...
 */
class PostDeerRequestDeersInnerClassesTradeDoes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_deer_request_deers_inner_classes_tradeDoes';
    ...
    */
    ...
    public function setHeadSold($head_sold)
    {
        ...
        if (($head_sold < 0)) {
            throw new \InvalidArgumentException('invalid value for $head_sold when calling PostDeerRequestDeersInnerClassesTradeDoes., must be bigger than or equal to 0.');
        }
    ...
    public function setSaleWeight($sale_weight)
    {
        ...
        if (($sale_weight < 0)) {
            throw new \InvalidArgumentException('invalid value for $sale_weight when calling PostDeerRequestDeersInnerClassesTradeDoes., must be bigger than or equal to 0.');
        }
