 ...
 */
class PostPorkRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'post_pork_request';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['pork'] === null) {
            $invalidProperties[] = "'pork' can't be null";
        }
     ...
     * Gets pork
     *
     * @return \OpenAPI\Client\Model\PostPorkRequestPorkInner[]
     */
    public function getPork()
    {
        return $this->container['pork'];
    }

    /**
     * Sets pork
     *
     * @param \OpenAPI\Client\Model\PostPorkRequestPorkInner[] $pork pork
     *
     * @return self
     */
    public function setPork($pork)
    {
        if (is_null($pork)) {
            throw new \InvalidArgumentException('non-nullable pork cannot be null');
        }
        $this->container['pork'] = $pork;
     ...
     * Gets vegetation
     *
     * @return \OpenAPI\Client\Model\PostPorkRequestVegetationInner[]
     */
     ...
     * Sets vegetation
     *
     * @param \OpenAPI\Client\Model\PostPorkRequestVegetationInner[] $vegetation vegetation
     *
     * @return self
     */
