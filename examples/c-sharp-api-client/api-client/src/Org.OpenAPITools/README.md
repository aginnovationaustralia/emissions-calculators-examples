...
inputSpec: https://d2awla29kxgk7i.cloudfront.net/api/3.0.0/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{17E37FB8-3C22-43ED-8CB5-13BF3E57BE6D}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IPostAquacultureApiResponse apiResponse = await api.PostAquacultureAsync("todo");
            PostAquaculture200Response? model = apiResponse.Ok();
        }
...
## Api Information
- appName: AIA Calculator API
- appVersion: 3.0.0
- appDescription: Emissions Calculators for various farming activities
