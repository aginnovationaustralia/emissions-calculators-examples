...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    public partial class PostWildseafisheries200ResponseIntermediateInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PostWildseafisheries200ResponseIntermediateInner" /> class.
        /// </summary>
        ...
        public PostWildseafisheries200ResponseIntermediateInnerIntensities Intensities { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PostWildseafisheries200ResponseIntermediateInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PostWildseafisheries200ResponseIntermediateInner" />
    /// </summary>
    public class PostWildseafisheries200ResponseIntermediateInnerJsonConverter : JsonConverter<PostWildseafisheries200ResponseIntermediateInner>
    {
        /// <summary>
        /// Deserializes json to <see cref="PostWildseafisheries200ResponseIntermediateInner" />
        /// </summary>
        ...
        public override PostWildseafisheries200ResponseIntermediateInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!id.IsSet)
                throw new ArgumentException("Property is required for class PostWildseafisheries200ResponseIntermediateInner.", nameof(id));

            if (!scope1.IsSet)
                throw new ArgumentException("Property is required for class PostWildseafisheries200ResponseIntermediateInner.", nameof(scope1));

            if (!scope2.IsSet)
                throw new ArgumentException("Property is required for class PostWildseafisheries200ResponseIntermediateInner.", nameof(scope2));

            if (!scope3.IsSet)
                throw new ArgumentException("Property is required for class PostWildseafisheries200ResponseIntermediateInner.", nameof(scope3));
            ...
            if (scope1.IsSet && scope1.Value == null)
                throw new ArgumentNullException(nameof(scope1), "Property is not nullable for class PostWildseafisheries200ResponseIntermediateInner.");

            if (scope2.IsSet && scope2.Value == null)
                throw new ArgumentNullException(nameof(scope2), "Property is not nullable for class PostWildseafisheries200ResponseIntermediateInner.");

            if (scope3.IsSet && scope3.Value == null)
                throw new ArgumentNullException(nameof(scope3), "Property is not nullable for class PostWildseafisheries200ResponseIntermediateInner.");
        ...
        /// <summary>
        /// Serializes a <see cref="PostWildseafisheries200ResponseIntermediateInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="postWildseafisheries200ResponseIntermediateInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, PostWildseafisheries200ResponseIntermediateInner postWildseafisheries200ResponseIntermediateInner, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, postWildseafisheries200ResponseIntermediateInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PostWildseafisheries200ResponseIntermediateInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="postWildseafisheries200ResponseIntermediateInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, PostWildseafisheries200ResponseIntermediateInner postWildseafisheries200ResponseIntermediateInner, JsonSerializerOptions jsonSerializerOptions)
        {
            if (postWildseafisheries200ResponseIntermediateInner.Id == null)
                throw new ArgumentNullException(nameof(postWildseafisheries200ResponseIntermediateInner.Id), "Property is required for class PostWildseafisheries200ResponseIntermediateInner.");

            if (postWildseafisheries200ResponseIntermediateInner.Scope1 == null)
                throw new ArgumentNullException(nameof(postWildseafisheries200ResponseIntermediateInner.Scope1), "Property is required for class PostWildseafisheries200ResponseIntermediateInner.");

            if (postWildseafisheries200ResponseIntermediateInner.Scope2 == null)
                throw new ArgumentNullException(nameof(postWildseafisheries200ResponseIntermediateInner.Scope2), "Property is required for class PostWildseafisheries200ResponseIntermediateInner.");

            if (postWildseafisheries200ResponseIntermediateInner.Scope3 == null)
                throw new ArgumentNullException(nameof(postWildseafisheries200ResponseIntermediateInner.Scope3), "Property is required for class PostWildseafisheries200ResponseIntermediateInner.");

            if (postWildseafisheries200ResponseIntermediateInner.PurchasedOffsets == null)
                throw new ArgumentNullException(nameof(postWildseafisheries200ResponseIntermediateInner.PurchasedOffsets), "Property is required for class PostWildseafisheries200ResponseIntermediateInner.");

            if (postWildseafisheries200ResponseIntermediateInner.Intensities == null)
                throw new ArgumentNullException(nameof(postWildseafisheries200ResponseIntermediateInner.Intensities), "Property is required for class PostWildseafisheries200ResponseIntermediateInner.");
            ...
            JsonSerializer.Serialize(writer, postWildseafisheries200ResponseIntermediateInner.Scope1, jsonSerializerOptions);
            writer.WritePropertyName("scope2");
            JsonSerializer.Serialize(writer, postWildseafisheries200ResponseIntermediateInner.Scope2, jsonSerializerOptions);
