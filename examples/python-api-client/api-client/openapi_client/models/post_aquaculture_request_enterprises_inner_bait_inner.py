...
class PostAquacultureRequestEnterprisesInnerBaitInner(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Whole Sardines', 'Low Animal Protein Formulated Feed', 'High Animal Protein Formulated Feed', 'Cereal Grain', 'Squid', 'Whole Fish']):
            raise ValueError("must be one of enum values ('Whole Sardines', 'Low Animal Protein Formulated Feed', 'High Animal Protein Formulated Feed', 'Cereal Grain', 'Squid', 'Whole Fish')")
        return value
