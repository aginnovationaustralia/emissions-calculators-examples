...
class PostBuffaloRequest(BaseModel):
    ...
    buffalos: List[PostBuffaloRequestBuffalosInner]
    vegetation: List[PostBuffaloRequestVegetationInner]
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["state", "rainfallAbove600", "buffalos", "vegetation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in buffalos (list)
        _items = []
        if self.buffalos:
            for _item_buffalos in self.buffalos:
                if _item_buffalos:
                    _items.append(_item_buffalos.to_dict())
            _dict['buffalos'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "buffalos": [PostBuffaloRequestBuffalosInner.from_dict(_item) for _item in obj["buffalos"]] if obj.get("buffalos") is not None else None,
            "vegetation": [PostBuffaloRequestVegetationInner.from_dict(_item) for _item in obj["vegetation"]] if obj.get("vegetation") is not None else None
        })
