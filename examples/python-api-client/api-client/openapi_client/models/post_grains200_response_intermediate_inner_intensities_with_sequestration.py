...
class PostGrains200ResponseIntermediateInnerIntensitiesWithSequestration(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostGrains200ResponseIntermediateInnerIntensitiesWithSequestration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostGrains200ResponseIntermediateInnerIntensitiesWithSequestration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "grainProducedTonnes": obj.get("grainProducedTonnes"),
            "grainsExcludingSequestration": obj.get("grainsExcludingSequestration"),
