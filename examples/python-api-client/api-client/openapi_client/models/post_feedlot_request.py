...
class PostFeedlotRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in feedlots (list)
        _items = []
        if self.feedlots:
            for _item_feedlots in self.feedlots:
                if _item_feedlots:
                    _items.append(_item_feedlots.to_dict())
            _dict['feedlots'] = _items
