...
class PostDairy200Response(BaseModel):
    ...
    intermediate: List[PostDairy200ResponseIntermediateInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scope1": PostDairy200ResponseScope1.from_dict(obj["scope1"]) if obj.get("scope1") is not None else None,
            ...
            "intermediate": [PostDairy200ResponseIntermediateInner.from_dict(_item) for _item in obj["intermediate"]] if obj.get("intermediate") is not None else None
        })
