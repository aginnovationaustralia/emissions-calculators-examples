...
class PostPoultryRequestLayersInnerMeatChickenLayersEggSale(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostPoultryRequestLayersInnerMeatChickenLayersEggSale from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostPoultryRequestLayersInnerMeatChickenLayersEggSale from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "eggsProduced": obj.get("eggsProduced"),
            "averageWeight": obj.get("averageWeight")
        })
