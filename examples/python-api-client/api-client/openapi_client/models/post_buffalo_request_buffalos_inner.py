...
class PostBuffaloRequestBuffalosInner(BaseModel):
    """
    Input data required for a single Buffalo enterprise
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this Buffalo activity")
    ...
    cows_calving: PostBuffaloRequestBuffalosInnerCowsCalving = Field(alias="cowsCalving")
    seasonal_calving: PostBuffaloRequestBuffalosInnerSeasonalCalving = Field(alias="seasonalCalving")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "classes", "limestone", "limestoneFraction", "fertiliser", "diesel", "petrol", "lpg", "electricitySource", "electricityRenewable", "electricityUse", "grainFeed", "hayFeed", "herbicide", "herbicideOther", "cowsCalving", "seasonalCalving"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of cows_calving
        if self.cows_calving:
            _dict['cowsCalving'] = self.cows_calving.to_dict()
        # override the default output from pydantic by calling `to_dict()` of seasonal_calving
        if self.seasonal_calving:
            _dict['seasonalCalving'] = self.seasonal_calving.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "classes": PostBuffaloRequestBuffalosInnerClasses.from_dict(obj["classes"]) if obj.get("classes") is not None else None,
            ...
            "cowsCalving": PostBuffaloRequestBuffalosInnerCowsCalving.from_dict(obj["cowsCalving"]) if obj.get("cowsCalving") is not None else None,
            "seasonalCalving": PostBuffaloRequestBuffalosInnerSeasonalCalving.from_dict(obj["seasonalCalving"]) if obj.get("seasonalCalving") is not None else None
        })
