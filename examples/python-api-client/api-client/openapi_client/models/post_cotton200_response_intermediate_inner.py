...
class PostCotton200ResponseIntermediateInner(BaseModel):
    """
    Intermediate emissions calculation output for the Cotton calculator
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for this Cotton activity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intensities": PostCotton200ResponseIntermediateInnerIntensities.from_dict(obj["intensities"]) if obj.get("intensities") is not None else None,
