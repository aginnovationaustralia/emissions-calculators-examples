...
class PostProcessing200ResponseIntermediateInner(BaseModel):
    """
    Intermediate emissions calculation output for the Processing calculator
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for this Processing activity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intensities": PostProcessing200ResponseIntensitiesInner.from_dict(obj["intensities"]) if obj.get("intensities") is not None else None,
