...
class PostPorkRequestPorkInnerClassesSlaughterPigs(BaseModel):
    """
    Slaughter Pigs
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of manure
        if self.manure:
            _dict['manure'] = self.manure.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manure": PostPorkRequestPorkInnerClassesSowsManure.from_dict(obj["manure"]) if obj.get("manure") is not None else None
        })
