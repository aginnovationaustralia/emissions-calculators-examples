...
class PostRice200Response(BaseModel):
    """
    ...
    intermediate: List[PostRice200ResponseIntermediateInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scope1": PostRice200ResponseScope1.from_dict(obj["scope1"]) if obj.get("scope1") is not None else None,
            ...
            "intermediate": [PostRice200ResponseIntermediateInner.from_dict(_item) for _item in obj["intermediate"]] if obj.get("intermediate") is not None else None,
            "net": PostCotton200ResponseNet.from_dict(obj["net"]) if obj.get("net") is not None else None,
            "intensities": PostRice200ResponseIntensities.from_dict(obj["intensities"]) if obj.get("intensities") is not None else None
        })
