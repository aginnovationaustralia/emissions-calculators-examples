...
class PostBeefRequestBeefInnerClassesBullsGt1PurchasesInner(BaseModel):
    """
    Beef purchase
    """ # noqa: E501
    ...
    purchase_source: StrictStr = Field(description="Source location of livestock purchase", alias="purchaseSource")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostBeefRequestBeefInnerClassesBullsGt1PurchasesInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostBeefRequestBeefInnerClassesBullsGt1PurchasesInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "purchaseSource": obj.get("purchaseSource")
        })
