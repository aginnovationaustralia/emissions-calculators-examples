...
class PostHorticulture200ResponseIntermediateInner(BaseModel):
    """
    Intermediate emissions calculation output for the Horticulture calculator
    """ # noqa: E501
    id: StrictStr = Field(description="Unique identifier for this Horticulture activity")
    scope1: PostHorticulture200ResponseScope1
    scope2: PostAquaculture200ResponseScope2
    scope3: PostCotton200ResponseScope3
    intensities_with_sequestration: PostHorticulture200ResponseIntermediateInnerIntensitiesWithSequestration = Field(alias="intensitiesWithSequestration")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intensitiesWithSequestration": PostHorticulture200ResponseIntermediateInnerIntensitiesWithSequestration.from_dict(obj["intensitiesWithSequestration"]) if obj.get("intensitiesWithSequestration") is not None else None,
