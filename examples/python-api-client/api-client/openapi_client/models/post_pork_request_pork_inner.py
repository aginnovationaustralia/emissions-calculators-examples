...
class PostPorkRequestPorkInner(BaseModel):
    ...
    bedding_hay_barley_straw: Union[Annotated[float, Field(strict=True, ge=0)], Annotated[int, Field(strict=True, ge=0)]] = Field(description="Hay, barley, straw, etc. purchased for pig bedding, in tonnes", alias="beddingHayBarleyStraw")
