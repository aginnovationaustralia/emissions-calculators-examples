...
class PostAquacultureRequestEnterprisesInnerFluidWasteInner(BaseModel):
    """
    ...
    @field_validator('fluid_waste_treatment_type')
    def fluid_waste_treatment_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Managed Aerobic', 'Unmanaged Aerobic', 'Anaerobic Digester/Reactor', 'Shallow Anaerobic Lagoon <2m', 'Deep Anaerobic Lagoon >2m']):
            raise ValueError("must be one of enum values ('Managed Aerobic', 'Unmanaged Aerobic', 'Anaerobic Digester/Reactor', 'Shallow Anaerobic Lagoon <2m', 'Deep Anaerobic Lagoon >2m')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fluidWasteKl": obj.get("fluidWasteKl"),
            "fluidWasteTreatmentType": obj.get("fluidWasteTreatmentType"),
            "averageInletCOD": obj.get("averageInletCOD"),
            "averageOutletCOD": obj.get("averageOutletCOD"),
            "flaredCombustedFraction": obj.get("flaredCombustedFraction")
        })
