...
class PostPoultry200ResponseIntermediateBroilersInner(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "intensities": PostPoultry200ResponseIntermediateBroilersInnerIntensities.from_dict(obj["intensities"]) if obj.get("intensities") is not None else None,
