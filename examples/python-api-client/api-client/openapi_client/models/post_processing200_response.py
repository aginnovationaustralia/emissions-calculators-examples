...
class PostProcessing200Response(BaseModel):
    ...
    intensities: List[PostProcessing200ResponseIntensitiesInner]
    carbon_sequestration: PostAquaculture200ResponseCarbonSequestration = Field(alias="carbonSequestration")
    intermediate: List[PostProcessing200ResponseIntermediateInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scope1": PostProcessing200ResponseScope1.from_dict(obj["scope1"]) if obj.get("scope1") is not None else None,
            "scope2": PostAquaculture200ResponseScope2.from_dict(obj["scope2"]) if obj.get("scope2") is not None else None,
            "scope3": PostProcessing200ResponseScope3.from_dict(obj["scope3"]) if obj.get("scope3") is not None else None,
            ...
            "net": PostProcessing200ResponseNet.from_dict(obj["net"]) if obj.get("net") is not None else None,
            "intensities": [PostProcessing200ResponseIntensitiesInner.from_dict(_item) for _item in obj["intensities"]] if obj.get("intensities") is not None else None,
            ...
            "intermediate": [PostProcessing200ResponseIntermediateInner.from_dict(_item) for _item in obj["intermediate"]] if obj.get("intermediate") is not None else None
        })
