...
class PostDairyRequestDairyInnerAreas(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "croppedDryland": obj.get("croppedDryland") if obj.get("croppedDryland") is not None else 0,
            "croppedIrrigated": obj.get("croppedIrrigated") if obj.get("croppedIrrigated") is not None else 0,
            "improvedPastureDryland": obj.get("improvedPastureDryland") if obj.get("improvedPastureDryland") is not None else 0,
            "improvedPastureIrrigated": obj.get("improvedPastureIrrigated") if obj.get("improvedPastureIrrigated") is not None else 0
        })
