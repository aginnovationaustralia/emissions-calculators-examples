...
class PostGoatRequest(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in goats (list)
        _items = []
        if self.goats:
            for _item_goats in self.goats:
                if _item_goats:
                    _items.append(_item_goats.to_dict())
            _dict['goats'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vegetation": [PostGoatRequestVegetationInner.from_dict(_item) for _item in obj["vegetation"]] if obj.get("vegetation") is not None else None
        })
