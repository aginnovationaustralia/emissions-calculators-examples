...
class PostWildcatchfisheryRequestEnterprisesInner(BaseModel):
    ...
    def production_system_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Abalone', 'Crab Fishing', 'Demersal Trawl', 'Gillnet', 'Handline', 'Lobster Pot', 'Longline', 'Northern Fish Trap', 'Northern Prawn trawl', 'Otter Board Trawl', 'Prawn trawl Australian average', 'Purse seine', 'Southern Ocean Longline']):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bait": [PostWildcatchfisheryRequestEnterprisesInnerBaitInner.from_dict(_item) for _item in obj["bait"]] if obj.get("bait") is not None else None,
