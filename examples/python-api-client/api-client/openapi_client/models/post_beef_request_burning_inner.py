...
class PostBeefRequestBurningInner(BaseModel):
    """
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of burning
        if self.burning:
            _dict['burning'] = self.burning.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "burning": PostBeefRequestBurningInnerBurning.from_dict(obj["burning"]) if obj.get("burning") is not None else None,
