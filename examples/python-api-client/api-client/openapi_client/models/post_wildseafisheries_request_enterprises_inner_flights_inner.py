...
class PostWildseafisheriesRequestEnterprisesInnerFlightsInner(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostWildseafisheriesRequestEnterprisesInnerFlightsInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostWildseafisheriesRequestEnterprisesInnerFlightsInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "commercialFlightPassengers": obj.get("commercialFlightPassengers"),
            "totalFlightDistance": obj.get("totalFlightDistance")
        })
