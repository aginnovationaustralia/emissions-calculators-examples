...
class PostDeer200ResponseIntensities(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deerMeatExcludingSequestration": obj.get("deerMeatExcludingSequestration"),
            "deerMeatIncludingSequestration": obj.get("deerMeatIncludingSequestration")
        })
