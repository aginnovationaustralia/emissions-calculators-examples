...
class PostGrainsRequest(BaseModel):
    ...
    vegetation: List[PostGrainsRequestVegetationInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vegetation": [PostGrainsRequestVegetationInner.from_dict(_item) for _item in obj["vegetation"]] if obj.get("vegetation") is not None else None
        })
