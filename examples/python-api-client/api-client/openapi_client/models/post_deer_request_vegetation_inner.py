...
class PostDeerRequestVegetationInner(BaseModel):
    """
    ...
    deer_proportion: List[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(description="The proportion of the sequestration that is allocated to each deer activity", alias="deerProportion")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["vegetation", "deerProportion"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "deerProportion": obj.get("deerProportion")
        })
