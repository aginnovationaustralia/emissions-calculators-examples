...
class PostProcessingRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["state", "products"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "state": obj.get("state"),
            "products": [PostProcessingRequestProductsInner.from_dict(_item) for _item in obj["products"]] if obj.get("products") is not None else None
        })
