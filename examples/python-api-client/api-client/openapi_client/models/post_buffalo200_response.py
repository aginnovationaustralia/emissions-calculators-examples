...
class PostBuffalo200Response(BaseModel):
    """
    ...
    intermediate: List[PostBuffalo200ResponseIntermediateInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "net": PostBuffalo200ResponseNet.from_dict(obj["net"]) if obj.get("net") is not None else None,
            "intensities": PostBuffalo200ResponseIntensities.from_dict(obj["intensities"]) if obj.get("intensities") is not None else None,
            "intermediate": [PostBuffalo200ResponseIntermediateInner.from_dict(_item) for _item in obj["intermediate"]] if obj.get("intermediate") is not None else None
        })
