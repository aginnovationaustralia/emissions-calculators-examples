...
class PostGoatRequestGoatsInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "classes", "limestone", "limestoneFraction", "fertiliser", "diesel", "petrol", "lpg", "mineralSupplementation", "electricitySource", "electricityRenewable", "electricityUse", "grainFeed", "hayFeed", "herbicide", "herbicideOther"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "classes": PostGoatRequestGoatsInnerClasses.from_dict(obj["classes"]) if obj.get("classes") is not None else None,
