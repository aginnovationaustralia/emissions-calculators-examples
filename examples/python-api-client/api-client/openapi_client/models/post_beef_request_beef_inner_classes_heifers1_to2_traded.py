...
class PostBeefRequestBeefInnerClassesHeifers1To2Traded(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "autumn": PostBeefRequestBeefInnerClassesBullsGt1Autumn.from_dict(obj["autumn"]) if obj.get("autumn") is not None else None,
