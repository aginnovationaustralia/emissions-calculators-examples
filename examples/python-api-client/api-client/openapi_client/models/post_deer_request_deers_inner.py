...
class PostDeerRequestDeersInner(BaseModel):
    """
    Input data required for a single Deer enterprise
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for this Deer activity")
    ...
    does_fawning: PostDeerRequestDeersInnerDoesFawning = Field(alias="doesFawning")
    seasonal_fawning: PostDeerRequestDeersInnerSeasonalFawning = Field(alias="seasonalFawning")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "classes", "limestone", "limestoneFraction", "fertiliser", "diesel", "petrol", "lpg", "electricitySource", "electricityRenewable", "electricityUse", "grainFeed", "hayFeed", "herbicide", "herbicideOther", "doesFawning", "seasonalFawning"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of does_fawning
        if self.does_fawning:
            _dict['doesFawning'] = self.does_fawning.to_dict()
        # override the default output from pydantic by calling `to_dict()` of seasonal_fawning
        if self.seasonal_fawning:
            _dict['seasonalFawning'] = self.seasonal_fawning.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "classes": PostDeerRequestDeersInnerClasses.from_dict(obj["classes"]) if obj.get("classes") is not None else None,
            ...
            "doesFawning": PostDeerRequestDeersInnerDoesFawning.from_dict(obj["doesFawning"]) if obj.get("doesFawning") is not None else None,
            "seasonalFawning": PostDeerRequestDeersInnerSeasonalFawning.from_dict(obj["seasonalFawning"]) if obj.get("seasonalFawning") is not None else None
        })
