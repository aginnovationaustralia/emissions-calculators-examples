...
class PostGrainsRequestVegetationInner(BaseModel):
    """
    PostGrainsRequestVegetationInner
    """ # noqa: E501
    vegetation: PostBeefRequestVegetationInnerVegetation
    allocation_to_crops: List[Union[Annotated[float, Field(le=1, strict=True, ge=0)], Annotated[int, Field(le=1, strict=True, ge=0)]]] = Field(description="The proportion of the sequestration that is allocated to each crop activity", alias="allocationToCrops")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostGrainsRequestVegetationInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostGrainsRequestVegetationInner from a dict"""
        if obj is None:
            return None
