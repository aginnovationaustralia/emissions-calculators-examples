...
class PostBuffaloRequestVegetationInner(BaseModel):
    ...
    buffalo_proportion: List[Union[StrictFloat, StrictInt]] = Field(description="The proportion of the sequestration that is allocated to Buffalo", alias="buffaloProportion")
