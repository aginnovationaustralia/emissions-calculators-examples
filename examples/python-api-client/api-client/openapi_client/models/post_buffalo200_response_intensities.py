...
class PostBuffalo200ResponseIntensities(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "buffaloMeatExcludingSequestration": obj.get("buffaloMeatExcludingSequestration"),
            "buffaloMeatIncludingSequestration": obj.get("buffaloMeatIncludingSequestration")
        })
