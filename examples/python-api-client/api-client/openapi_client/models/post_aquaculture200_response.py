...
class PostAquaculture200Response(BaseModel):
    """
    ...
    intermediate: List[PostAquaculture200ResponseIntermediateInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "scope1": PostAquaculture200ResponseScope1.from_dict(obj["scope1"]) if obj.get("scope1") is not None else None,
            ...
            "intensities": PostAquaculture200ResponseIntensities.from_dict(obj["intensities"]) if obj.get("intensities") is not None else None,
            ...
            "intermediate": [PostAquaculture200ResponseIntermediateInner.from_dict(_item) for _item in obj["intermediate"]] if obj.get("intermediate") is not None else None
        })
