...
class PostBeefRequestBeefInner(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "classes": PostBeefRequestBeefInnerClasses.from_dict(obj["classes"]) if obj.get("classes") is not None else None,
            ...
            "cowsCalving": PostBeefRequestBeefInnerCowsCalving.from_dict(obj["cowsCalving"]) if obj.get("cowsCalving") is not None else None
        })
