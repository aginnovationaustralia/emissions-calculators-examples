...
class PostBeefRequestBeefInnerClassesBullsGt1Autumn(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["head", "liveweight", "liveweightGain", "crudeProtein", "dryMatterDigestibility"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PostBeefRequestBeefInnerClassesBullsGt1Autumn from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PostBeefRequestBeefInnerClassesBullsGt1Autumn from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "liveweightGain": obj.get("liveweightGain"),
